			...
			<ul class="navbar-right">
				<?php
					if (!isset($_SESSION['user'])){
						...
						echo '<li><a href="vues/article.php" class="addarticle">AJOUTER UN ARTICLE</a></li>';
						echo '<li><a href="controleurs/deconnexion.php"><i class="fa fa-sign-out" aria-hidden="true"></i>DECONNEXION</a></li>';
					}
				?>
			</ul>
		</div>
